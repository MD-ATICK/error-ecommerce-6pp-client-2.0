...
function AdminProductCreate() {
    ...
    const [avatar, setavatar] = useState('/food.png');
    const token = localStorage.getItem('token')
    const { success } = useSelector((state) => state.AdminCreateProduct)
    ...
    const HandleSubmit = (w) => {
        ...
        dispatch(AdminCreateProductFetch(ProductDetails))
    ...
    <div className='dashboard'>
        ...
        <div className='h-screen bg-cyan-600 flex justify-center items-center'>
            <form action="" onSubmit={HandleSubmit} className='createproductfrom shadow-2xl shadow-zinc-700'>
                ...
                <button type='submit' className='text py-2 mb-2 rounded-md w-80 hover:scale-105 duration-75 mx-auto bg-orange-700 text-white cursor-pointer '>Create</button>
            </form>
